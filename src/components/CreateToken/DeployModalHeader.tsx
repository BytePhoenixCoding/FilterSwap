...
import { Trade, TradeType } from '../../custom_modules/@filterswap-libs/sdk/dist'
import { Button, Text } from '../../custom_modules/@filterswap-libs/uikit/dist'
...
import { DeployShowAcceptChanges } from './styleds'
...
export default function SwapModalHeader({
  ...
  return (
    <AutoColumn gap="md" style={{ marginTop: '20px' }}>
      ...
      {showAcceptChanges ? (
        <DeployShowAcceptChanges justify="flex-start" gap="0px">
          <RowBetween>
            <RowFixed>
