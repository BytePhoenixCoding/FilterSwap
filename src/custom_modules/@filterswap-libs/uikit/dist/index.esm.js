...
var StyledButton = styled.button(templateObject_1$T || (templateObject_1$T = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.Filter-button--disabled):not(.Filter-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.Filter-button--disabled):not(.Filter-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.Filter-button--disabled):not(.Filter-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.Filter-button--disabled):not(.Filter-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ",
    "\n  ",
...
var Button = function (props) {
    ...
    if (isLoading) {
        classNames.push("Filter-button--loading");
    }
    if (isDisabled && !isLoading) {
        classNames.push("Filter-button--disabled");
    }
...
var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 513 512" }, props),
        React.createElement("path", { d: "M444.251 238.316H67.4373C66.9392 244.194 66.6404 250.072 66.6404 256.05C66.6404 360.562 151.307 445.347 255.795 445.347C360.283 445.347 445.048 360.562 445.048 256.05C445.148 250.072 444.849 244.194 444.251 238.316ZM101.005 285.241C94.9288 285.241 90.0481 280.36 90.0481 274.282C90.0481 268.205 94.9288 263.323 101.005 263.323C107.081 263.323 111.962 268.205 111.962 274.282C111.862 280.36 106.981 285.241 101.005 285.241ZM111.862 316.625C111.862 310.548 116.842 305.666 122.819 305.666C128.895 305.666 133.776 310.548 133.776 316.625C133.776 322.702 128.895 327.584 122.819 327.584C116.842 327.584 111.862 322.603 111.862 316.625ZM135.867 369.828C129.791 369.828 124.911 364.946 124.911 358.868C124.911 352.791 129.891 347.909 135.867 347.909C141.943 347.909 146.824 352.791 146.824 358.868C146.824 364.946 141.943 369.828 135.867 369.828ZM135.867 285.241C129.791 285.241 124.911 280.36 124.911 274.282C124.911 268.205 129.891 263.323 135.867 263.323C141.943 263.323 146.824 268.205 146.824 274.282C146.824 280.36 141.943 285.241 135.867 285.241ZM164.953 316.625C164.953 310.548 169.834 305.666 175.91 305.666C181.986 305.666 186.866 310.548 186.866 316.625C186.866 322.702 181.986 327.584 175.91 327.584C169.933 327.584 164.953 322.603 164.953 316.625ZM179.993 405.894C173.917 405.894 169.037 400.912 169.037 394.934C169.037 388.857 173.917 383.975 179.993 383.975C186.069 383.975 190.95 388.857 190.95 394.934C190.851 401.012 185.97 405.894 179.993 405.894ZM179.993 369.828C173.917 369.828 169.037 364.946 169.037 358.868C169.037 352.791 173.917 347.909 179.993 347.909C186.069 347.909 190.95 352.791 190.95 358.868C190.851 364.946 185.97 369.828 179.993 369.828ZM179.993 285.241C173.917 285.241 169.037 280.36 169.037 274.282C169.037 268.205 173.917 263.323 179.993 263.323C186.069 263.323 190.95 268.205 190.95 274.282C190.851 280.36 185.97 285.241 179.993 285.241ZM230.594 415.359C224.518 415.359 219.637 410.377 219.637 404.399C219.637 398.421 224.518 393.44 230.594 393.44C236.67 393.44 241.551 398.322 241.551 404.399C241.551 410.477 236.57 415.359 230.594 415.359ZM230.594 369.828C224.518 369.828 219.637
        React.createElement("path", { d: "M472.54 276.075V276.374C472.54 276.773 472.44 277.072 472.44 277.371L429.012 275.876V238.216L472.64 236.722C472.64 237.12 472.739 237.419 472.739 237.817C473.735 250.67 473.636 263.422 472.54 276.075Z", fill: "#CCC" }),
        React.createElement("path", { d: "M511.088 234.829C506.207 175.847 480.907 120.254 439.57 77.7116L416.86 100.427C452.818 137.589 474.831 186.109 479.114 237.519C480.21 250.57 480.11 263.821 478.915 276.773C474.134 328.68 451.224 377.599 414.27 414.462C370.642 458.1 313.268 480.019 255.894 479.919C214.657 479.919 173.419 468.661 137.262 446.045L114.053 469.259C156.885 497.753 206.389 512 255.894 512C321.436 512 387.077 486.993 436.98 437.078C479.214 394.835 505.41 338.843 510.889 279.563C512.283 264.817 512.383 249.773 511.088 234.829ZM255.894 32.081C298.626 32.081 339.465 43.9369 374.726 66.1545L397.934 42.9407C356.298 15.0442 307.192 0 255.894 0C187.564 0 123.217 26.6013 74.8082 75.0216C-23.5041 173.357 -24.8987 332.566 70.5251 432.794L93.2355 410.078C10.2627 322.404 11.6572 183.619 97.5186 97.6377C139.852 55.3944 196.03 32.081 255.894 32.081Z", fill: "#CCC" }),
        React.createElement("path", { d: "M416.959 135.696L404.209 67.0511L472.739 79.9035L416.959 135.696Z", fill: "#CCC" }),
        React.createElement("path", { d: "M94.9288 376.503L107.679 445.048L39.0492 432.296L94.9288 376.503Z", fill: "#CCC" }),
        React.createElement("path", { d: "M137.959 176.445C137.86 181.726 143.139 185.213 148.219 183.419C155.291 180.929 161.666 181.726 167.244 187.006C173.021 192.486 174.117 201.253 170.132 208.128C166.148 214.902 158.08 218.091 150.51 215.998C142.84 213.807 137.66 206.633 137.959 198.762C137.959 198.065 138.059 197.467 138.158 196.77C138.557 192.087 136.067 188.7 131.784 188.002C127.6 187.305 124.014 189.895 123.018 194.379C122.122 198.862 120.129 202.648 116.344 205.438C110.468 209.722 104.192 210.32 97.8175 206.932C91.4426 203.545 88.3548 197.965 88.6536 190.792C88.9524 183.519 92.8371 178.637 99.2119 175.847C105.786 173.357 111.563 174.353 116.942 178.438C120.926 181.427 125.707 180.829 128.297 177.143C130.588 173.855 129.991 169.67 126.504 166.582C122.221 162.796 119.731 158.213 119.831 152.335C120.03 143.966 126.405 136.792 134.573 135.696C143.039 134.601 151.406 139.781 153.598 147.652C155.988 156.32 152.103 165.087 144.234 168.475C140.748 170.069 138.059 172.261 137.959 176.445Z", fill: "#CCC" }),
        React.createElement("path", { d: "M284.382 210.419C271.234 213.109 258.285 215.799 244.937 218.489L268.245 150.242C273.823 170.766 279.103 190.493 284.382 210.419Z", fill: "#CCC" }),
        React.createElement("path", { d: "M239.857 226.759C239.16 228.851 238.363 230.943 237.666 233.135H224.817C221.331 220.083 217.944 207.231 214.458 194.379C214.657 194.379 214.856 194.279 215.055 194.279C223.024 203.445 230.893 212.711 238.861 221.877C240.256 223.371 240.555 224.766 239.857 226.759Z", fill: "#CCC" }),
        React.createElement("path", { d: "M281.493 217.194C274.521 222.574 267.548 227.854 260.675 233.035H239.857C240.654 230.644 241.451 228.353 242.248 226.061C242.547 225.364 243.643 224.467 244.439 224.367C256.293 221.877 268.046 219.386 279.9 216.995C280.198 216.995 280.497 217.094 281.493 217.194Z", fill: "#CCC" }),
        React.createElement("path", { d: "M319.942 107.601C313.965 117.066 307.889 126.73 301.813 136.493C292.251 130.516 282.589 124.438 273.126 118.46C275.417 114.874 277.708 111.287 279.999 107.601C285.776 111.287 291.753 115.073 297.829 118.859C301.614 112.682 305.399 106.704 309.084 100.826C312.87 103.217 316.455 105.409 319.942 107.601Z", fill: "#CCC" }),
        React.createElement("path", { d: "M313.168 77.7116C310.977 81.2983 308.686 84.885 306.495 88.4717C300.618 84.7854 294.641 80.9994 288.565 77.1138C284.681 83.3905 280.896 89.468 277.21 95.4458C273.425 93.0547 269.839 90.7632 266.253 88.5713C272.23 79.0068 278.306 69.3427 284.382 59.6785C293.944 65.6563 303.606 71.7338 313.168 77.7116Z", fill: "#CCC" }),
        React.createElement("path", { d: "M331.496 89.0694C329.305 92.6561 327.014 96.2428 324.723 99.9291C321.336 97.8369 317.75 95.5454 314.264 93.3536C316.455 89.7669 318.746 86.1802 321.037 82.4938C324.524 84.6857 328.01 86.8776 331.496 89.0694Z", fill: "#CCC" }),
        React.createElement("path", { d: "M301.714 96.1432C299.522 99.6303 297.331 103.117 295.139 106.604C291.653 104.413 288.167 102.221 284.681 100.029C286.872 96.5417 289.063 93.0547 291.255 89.5676C294.641 91.6599 298.227 93.9514 301.714 96.1432Z", fill: "#CCC" }),
        React.createElement("path", { d: "M272.13 102.818C269.939 106.306 267.648 109.992 265.357 113.579C261.97 111.387 258.384 109.195 254.798 106.903C256.99 103.416 259.281 99.8295 261.572 96.1432C265.058 98.3351 268.544 100.627 272.13 102.818Z", fill: "#CCC" }),
    ));
};
...
var Icon$P = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear_Filters", x1: "25.691", y1: "9.6549", x2: "25.691", y2: "40.2608", gradientUnits: "userSpaceOnUse" },
...
var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("circle", { cx: "45", cy: "45", r: "45", fill: "url(#paint0_linear_Filterround)" }),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear_Filterround", x1: "45", y1: "0", x2: "45", y2: "90", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { stopColor: "#54DADE" }),
                React.createElement("stop", { offset: "0.762157", stopColor: "#24C7D6" })),
            React.createElement("linearGradient", { id: "paint1_linear_Filterround", x1: "38.7618", y1: "24.0704", x2: "38.7618", y2: "51.8948", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { stopColor: "#9F4A08" }),
                React.createElement("stop", { offset: "0.370494", stopColor: "#7D3900" }),
                React.createElement("stop", { offset: "1", stopColor: "#8D4104" })))));
};
...
var FilterStack = styled.div(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n\n  &:label:before {\n    content: none;\n  }\n\n  .Filters {\n    transition: 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275);\n  }\n\n  .Filter {\n    background: #e27c31;\n    border-radius: 50%;\n    width: ", ";\n    height: ", ";\n    position: absolute;\n    transition: 0.4s ease;\n    top: 2px;\n    left: 4px;\n    box-shadow: 0 ", " 0 ", " #fbbe7c;\n  }\n\n  .Filter:nth-child(1) {\n    background: ", ";\n    box-shadow: 0 ", " 0 ", "\n      ", ";\n  }\n\n  .Filter:nth-child(2) {\n    left: 0;\n    top: ", ";\n    transform: scale(0);\n    transition: 0.2s ease 0.2s;\n  }\n\n  .Filter:nth-child(3) {\n    top: ", ";\n    transform: scale(0);\n    transition: 0.2s ease 0.2s;\n  }\n\n  .Filter:nth-child(3):before,\n  .Filter:nth-child(3):after {\n    content: \"\";\n    position: absolute;\n    background: #ef8927;\n    border-radius: 20px;\n    width: 50%;\n    height: 20%;\n  }\n\n  .Filter:nth-child(3):before {\n    top: ", ";\n    left: ", ";\n  }\n\n  .Filter:nth-child(3):after {\n    top: ", ";\n    right: ", ";\n  }\n\n  .butter {\n    width: ", ";\n    height: ", ";\n    background: #fbdb60;\n    top: ", ";\n    left: ", ";\n    position: absolute;\n    border-radius: ", ";\n    box-shadow: 0 ", " 0 ", " #d67823;\n    transform: scale(0);\n    transition: 0.2s ease;\n  }\n"], ["\n  position: relative;\n  display: inline-block;\n\n  &:label:before {\n    content: none;\n  }\n\n  .Filters {\n    transition: 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275);\n  }\n\n  .Filter {\n    background: #e27c31;\n    border-radius: 50%;\n    width: ", ";\n    height: ", ";\n    position: absolute;\n    transition: 0.4s ease;\n    top: 2px;\n    left: 4px;\n    box-shadow: 0 ", " 0 ", " #fbbe7c;\n  }\n\n  .Filter:nth-child(1) {\n    background: ", ";\n    box-shadow: 0 ", " 0 ", "\n      ", ";\n  }\n\n  .Filter:nth-child(2) {\n    left: 0;\n    top: ", ";\n    transform: scale(0);\n    transition: 0.2s ease 0.2s;\n  }\n\n  .Filter:nth-child(3) {\n    top: ", ";\n    transform: scale(0);\n    transition: 0.2s ease 0.2s;\n  }\n\n  .Filter:nth-child(3):before,\n  .Filter:nth-child(3):after {\n    content: \"\";\n    position: absolute;\n    background: #ef8927;\n    border-radius: 20px;\n    width: 50%;\n    height: 20%;\n  }\n\n  .Filter:nth-child(3):before {\n    top: ", ";\n    left: ", ";\n  }\n\n  .Filter:nth-child(3):after {\n    top: ", ";\n    right: ", ";\n  }\n\n  .butter {\n    width: ", ";\n    height: ", ";\n    background: #fbdb60;\n    top: ", ";\n    left: ", ";\n    position: absolute;\n    border-radius: ", ";\n    box-shadow: 0 ", " 0 ", " #d67823;\n    transform: scale(0);\n    transition: 0.2s ease;\n  }\n"])), getScale$2("FilterSize"), getScale$2("FilterSize"), getScale$2("FilterThickness"), getScale$2("FilterThickness"), function (_a) {
    var theme = _a.theme;
    return theme.FilterToggle.handleBackground;
}, getScale$2("FilterThickness"), getScale$2("FilterThickness"), function (_a) {
    var theme = _a.theme;
    return theme.FilterToggle.handleShadow;
}, getScale$2("FilterTwoOffset"), getScale$2("FilterThreeOffset"), getScale$2("butterSmearOneTop"), getScale$2("butterSmearOneLeft"), getScale$2("butterSmearTwoTop"), getScale$2("butterSmearTwoRight"), getScale$2("butterWidth"), getScale$2("butterHeight"), getScale$2("butterTop"), getScale$2("butterLeft"), getScale$2("butterRadius"), getScale$2("butterThickness"), getScale$2("butterThickness"));
var FilterInput = styled.input(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  height: 40px;\n  left: 0;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  width: 40px;\n\n  &:focus + label {\n    box-shadow: ", ";\n  }\n\n  &:checked + label .Filters {\n    transform: translateX(", ");\n  }\n\n  &:checked + label .Filter:nth-child(1) {\n    background: #e27c31;\n    box-shadow: 0 ", " 0 ", " #fbbe7c;\n    transition-delay: 0.2s;\n  }\n\n  &:checked + label .Filter:nth-child(2) {\n    transform: scale(1);\n    transition-delay: 0.2s;\n  }\n\n  &:checked + label .Filter:nth-child(3) {\n    transform: scale(1);\n    transition-delay: 0.4s;\n  }\n\n  &:checked + label .butter {\n    transform: scale(1);\n    transition-delay: 0.6s;\n  }\n"], ["\n  height: 40px;\n  left: 0;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  width: 40px;\n\n  &:focus + label {\n    box-shadow: ", ";\n  }\n\n  &:checked + label .Filters {\n    transform: translateX(", ");\n  }\n\n  &:checked + label .Filter:nth-child(1) {\n    background: #e27c31;\n    box-shadow: 0 ", " 0 ", " #fbbe7c;\n    transition-delay: 0.2s;\n  }\n\n  &:checked + label .Filter:nth-child(2) {\n    transform: scale(1);\n    transition-delay: 0.2s;\n  }\n\n  &:checked + label .Filter:nth-child(3) {\n    transform: scale(1);\n    transition-delay: 0.4s;\n  }\n\n  &:checked + label .butter {\n    transform: scale(1);\n    transition-delay: 0.6s;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.shadows.focus;
}, getScale$2("travelDistance"), getScale$2("FilterThickness"), getScale$2("FilterThickness"));
var FilterLabel = styled.label(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n  box-shadow: ", ";\n  display: inline-block;\n  border-radius: 50px;\n  position: relative;\n  transition: all 0.3s ease;\n  transform-origin: 20% center;\n  cursor: pointer;\n"], ["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n  box-shadow: ", ";\n  display: inline-block;\n  border-radius: 50px;\n  position: relative;\n  transition: all 0.3s ease;\n  transform-origin: 20% center;\n  cursor: pointer;\n"])), getScale$2("toggleWidth"), getScale$2("toggleHeight"), function (_a) {
...
var FilterToggle = function (_a) {
    ...
    return (React.createElement(FilterStack, { scale: scale },
        React.createElement(FilterInput, __assign({ id: props.id || "Filter-toggle", scale: scale, type: "checkbox", checked: checked }, props)),
        React.createElement(FilterLabel, { scale: scale, checked: checked, htmlFor: props.id || "Filter-toggle" },
...
var RotatingFilterIcon = styled(Icon$q)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$r)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React.createElement(Container$3, null,
        React.createElement(RotatingFilterIcon, { width: size * 0.5 + "px" }),
...
var Logo$2 = function (_a) {
    ...
    return (
        React.createElement(Svg, __assign({ viewBox: "0 0 147 27" }, props),
            ...
            React.createElement("path", { d: "M17.4208 6.09214H19.4219V20.9223H17.4208V6.09214ZM18.4324 2.84596C18.0156 2.84596 17.6681 2.707 17.3874 2.42351C17.104 2.14281 16.965 1.80652 16.965 1.41186C16.965 1.03388 17.104 0.705932 17.3874 0.422448C17.6681 0.141742 18.0156 0 18.4324 0C18.8466 0 19.194 0.138963 19.4774 0.411331C19.7582 0.686477 19.8999 1.01165 19.8999 1.38963C19.8999 1.79818 19.7582 2.14281 19.4774 2.42351C19.194 2.707 18.8466 2.84596 18.4324 2.84596Z", fill: textColor }),
            React.createElement("path", { d: "M25.0034 0H27.0045V20.9223H25.0034V0Z", fill: textColor }),
            React.createElement("path", { d: "M40.4014 20.0218C40.0234 20.3553 39.5565 20.6166 39.0007 20.8C38.4448 20.9779 37.8667 21.0668 37.2664 21.0668C35.8712 21.0668 34.7984 20.6944 34.0425 19.944C33.292 19.188 32.9196 18.1263 32.9196 16.7534V7.78193H30.2738V6.09214H32.9196V2.84596H34.9318V6.09214H39.4342V7.78193H34.9318V16.6422C34.9318 17.526 35.1486 18.1958 35.5877 18.6544C36.0324 19.1158 36.6661 19.3437 37.4887 19.3437C37.9028 19.3437 38.3031 19.2769 38.6894 19.1435C39.0729 19.0101 39.4064 18.8267 39.6899 18.5877L40.4014 20.0218Z", fill: textColor }),
            React.createElement("path", { d: "M56.9486 14.1298H44.542C44.6531 15.6722 45.2423 16.9174 46.3096 17.8651C47.3824 18.8156 48.7386 19.2881 50.3784 19.2881C51.2956 19.2881 52.1405 19.1269 52.9131 18.7989C53.6829 18.4654 54.35 17.9818 54.9142 17.3426L56.037 18.6433C55.3839 19.4298 54.5612 20.0301 53.569 20.4442C52.5824 20.8611 51.5012 21.0668 50.3228 21.0668C48.7942 21.0668 47.4435 20.7444 46.2651 20.0996C45.0923 19.4493 44.1779 18.5488 43.5192 17.3982C42.8661 16.2503 42.5409 14.9524 42.5409 13.5072C42.5409 12.062 42.8549 10.7669 43.4858 9.61624C44.114 8.46841 44.9783 7.57626 46.0761 6.93703C47.1711 6.30058 48.4051 5.98097 49.7781 5.98097C51.1566 5.98097 52.3906 6.30058 53.4801 6.93703C54.5695 7.57626 55.42 8.46563 56.037 9.60512C56.6595 10.7391 56.9708 12.0398 56.9708 13.5072L56.9486 14.1298ZM49.7781 7.70411C48.3551 7.70411 47.1572 8.15991 46.1873 9.07151C45.2145 9.9831 44.667 11.1698 44.542 12.629H55.0587C54.9253 11.1698 54.3722 9.9831 53.4022 9.07151C52.4378 8.15991 51.2289 7.70411 49.7781 7.70411Z", fill: textColor }),
            React.createElement("path", { d: "M62.9796 8.99369C63.4465 8.00149 64.1413 7.25387 65.0696 6.74804C66.0034 6.23666 67.154 5.98097 68.527 5.98097V7.92645L68.049 7.8931C66.4926 7.8931 65.2697 8.37669 64.3803 9.33831C63.4965 10.2944 63.0574 11.6368 63.0574 13.3627V20.9223H61.0563V6.09214H62.9796V8.99369Z", fill: textColor }),
            React.createElement("path", { d: "M78.2296 21.089C76.7622 21.089 75.3531 20.8556 74.0052 20.3887C72.6628 19.9162 71.6261 19.2936 70.8924 18.521L71.7151 16.9201C72.4265 17.6316 73.3743 18.2097 74.561 18.6544C75.745 19.0935 76.9679 19.3103 78.2296 19.3103C79.9917 19.3103 81.3146 18.9879 82.1984 18.3431C83.0795 17.6928 83.5214 16.8507 83.5214 15.8195C83.5214 15.0275 83.2796 14.3966 82.7987 13.9297C82.3235 13.4627 81.7371 13.1042 81.0423 12.8513C80.3447 12.5928 79.3775 12.3149 78.1407 12.0175C76.6566 11.6395 75.4726 11.2782 74.5833 10.928C73.6994 10.5806 72.9435 10.0498 72.3154 9.33831C71.6845 8.62126 71.3704 7.64852 71.3704 6.42565C71.3704 5.43345 71.6317 4.53019 72.1597 3.71309C72.685 2.89043 73.4938 2.24008 74.5833 1.75649C75.6727 1.26734 77.029 1.02277 78.6521 1.02277C79.7777 1.02277 80.8783 1.1784 81.9539 1.48968C83.035 1.7954 83.9716 2.22063 84.7665 2.76814L84.0661 4.42458C83.2351 3.8854 82.3485 3.47685 81.4091 3.20171C80.4669 2.92934 79.547 2.79038 78.6521 2.79038C76.9178 2.79038 75.6116 3.12389 74.7389 3.79091C73.8634 4.45793 73.4271 5.3195 73.4271 6.37006C73.4271 7.16493 73.6661 7.80138 74.1497 8.28219C74.6305 8.75745 75.2308 9.12431 75.9506 9.38278C76.676 9.63569 77.6516 9.91084 78.8744 10.2054C80.3196 10.5695 81.4869 10.9253 82.3763 11.2727C83.2712 11.6145 84.0272 12.1398 84.6442 12.8513C85.2667 13.5572 85.578 14.5077 85.578 15.7084C85.578 16.7034 85.3112 17.6094 84.7776 18.4321C84.244 19.2492 83.4213 19.8967 82.3096 20.3775C81.2035 20.8528 79.8444 21.089 78.2296 21.089Z", fill: textColor }),
            React.createElement("path", { d: "M111.463 6.09214L105.849 20.9223H103.959L99.2786 8.77135L94.5983 20.9223H92.7084L87.1276 6.09214H89.0509L93.6978 18.6989L98.467 6.09214H100.179L104.926 18.6989L109.629 6.09214H111.463Z", fill: textColor }),
            React.createElement("path", { d: "M119.665 5.98097C121.599 5.98097 123.081 6.46734 124.112 7.4373C125.148 8.4017 125.668 9.83302 125.668 11.7285V20.9223H123.745V18.6099C123.3 19.3826 122.639 19.9857 121.766 20.422C120.891 20.8528 119.848 21.0668 118.642 21.0668C116.988 21.0668 115.674 20.6749 114.696 19.8884C113.717 19.0963 113.228 18.0513 113.228 16.7534C113.228 15.4944 113.684 14.4799 114.596 13.7073C115.507 12.9375 116.958 12.5511 118.953 12.5511H123.667V11.6507C123.667 10.3694 123.306 9.3939 122.589 8.72688C121.877 8.05986 120.835 7.72634 119.465 7.72634C118.523 7.72634 117.619 7.88198 116.752 8.19326C115.891 8.50454 115.151 8.93254 114.529 9.47172L113.628 7.98204C114.376 7.34559 115.276 6.85366 116.33 6.50347C117.38 6.15606 118.492 5.98097 119.665 5.98097ZM118.953 19.4882C120.079 19.4882 121.046 19.2297 121.855 18.71C122.669 18.193 123.272 17.4426 123.667 16.4643V14.0408H119.009C116.474 14.0408 115.207 14.9274 115.207 16.6978C115.207 17.5594 115.535 18.2403 116.196 18.7433C116.855 19.2408 117.775 19.4882 118.953 19.4882Z", fill: textColor }),
            React.createElement("path", { d: "M138.742 5.98097C140.134 5.98097 141.393 6.2978 142.522 6.92592C143.647 7.55681 144.528 8.44617 145.167 9.59401C145.812 10.7363 146.135 12.0398 146.135 13.5072C146.135 14.9913 145.812 16.3059 145.167 17.4538C144.528 18.6044 143.65 19.4937 142.533 20.1218C141.421 20.7527 140.156 21.0668 138.742 21.0668C137.541 21.0668 136.454 20.8194 135.484 20.322C134.52 19.8189 133.728 19.088 133.105 18.1319V26.3919H131.104V6.09214H133.028V9.02704C133.628 8.04874 134.42 7.29834 135.407 6.77028C136.39 6.245 137.502 5.98097 138.742 5.98097ZM138.608 19.2881C139.637 19.2881 140.576 19.0518 141.421 18.5766C142.266 18.0958 142.927 17.4148 143.411 16.531C143.892 15.6417 144.134 14.6356 144.134 13.5072C144.134 12.3816 143.892 11.3811 143.411 10.5056C142.927 9.63292 142.266 8.94922 141.421 8.46007C140.576 7.97092 139.637 7.72634 138.608 7.72634C137.555 7.72634 136.61 7.97092 135.773 8.46007C134.934 8.94922 134.275 9.63292 133.795 10.5056C133.319 11.3811 133.083 12.3816 133.083 13.5072C133.083 14.6356 133.319 15.6417 133.795 16.531C134.275 17.4148 134.934 18.0958 135.773 18.5766C136.61 19.0518 137.555 19.2881 138.608 19.2881Z", fill: textColor }),
        ));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Filter home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Filter home page" }, innerLogo))));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: "Overview",
                href: "https://Filterswap.info",
            },
            {
                label: "Tokens",
                href: "https://Filterswap.info/tokens",
            },
            {
                label: "Pairs",
                href: "https://Filterswap.info/pairs",
            },
            {
                label: "Accounts",
                href: "https://Filterswap.info/accounts",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/Filterswap",
            },
            {
                label: "Docs",
                href: "https://docs.Filterswap.finance",
            },
            {
                label: "Blog",
                href: "https://Filterswap.medium.com",
            },
        ],
    },
];
...
//     return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://filterswap.exchange", target: "_blank" },
...
var ThemeSwitcher = function (_a) {
    ...
    return (React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(isDark); } },
        React.createElement(Flex, { alignItems: "center" },
            ...
            React.createElement(SunIcon, { color: isDark ? "text" : "textDisabled", width: "24px" }))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.Filterswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), {
    background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", dropdown: "#F6F6F6", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    }
});
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), {
    secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", dropdown: "#1E1D20", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#27262c", gradients: {
