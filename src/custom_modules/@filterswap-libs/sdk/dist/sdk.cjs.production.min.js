...
var v, y = "0x2f4ffbaf8ca4a7cd446769699594affc9562a0f48e7179939f2ad21a17dc3099",
	w = i.BigInt(1e3),
	T = i.BigInt(0),
	g = i.BigInt(1),
	k = i.BigInt(2),
...
var E = ((e = {})[v.uint8] = i.BigInt("0xff"), e[v.uint256] = i.BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), e);
...
function S(t, e, n) {
	return (S = B() ? Reflect.construct : function(t, e, n) {
		var r = [null];
		r.push.apply(r, e);
...
var M = "setPrototypeOf" in Object,
	X = function(t) {
		function e() {
			var n;
			return (n = t.call(this) || this).isInsufficientReservesError = !0, n.name = n.constructor.name, M && Object.setPrototypeOf(F(n), (this instanceof e ? this.constructor : void 0).prototype), n
		}
		return U(e, t), e
	}(D(Error)),
	L = function(t) {
		function e() {
			var n;
			return (n = t.call(this) || this).isInsufficientInputAmountError = !0, n.name = n.constructor.name, M && Object.setPrototypeOf(F(n), (this instanceof e ? this.constructor : void 0).prototype), n
		}
		return U(e, t), e
	}(D(Error));
...
var tt, et, nt = (($ = {})[exports.ChainId.MAINNET] = new K(exports.ChainId.MAINNET, "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c", 18, "WBNB", "Wrapped BNB"), $[exports.ChainId.BSCTESTNET] = new K(exports.ChainId.BSCTESTNET, "0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd", 18, "WBNB", "Wrapped BNB"), $),
	rt = c(d),
	ot = c(s),
	...
	ft = function(t) {
		...
		return n.invert = function() {
			...
			return Z(e.currency, this.baseCurrency) || u(!1), this.quoteCurrency instanceof K ? new dt(this.quoteCurrency, t.prototype.multiply.call(this, e.raw).quotient) : ct.ether(t.prototype.multiply.call(this, e.raw).quotient)
	...
	pt = function() {
		function t(e, n) {
			...
			this.liquidityToken = new K(r[0].token.chainId, t.getAddress(r[0].token, r[1].token), 18, "UNI-V2", "Uniswap V2"), this.tokenAmounts = r
		}
		t.getAddress = function(t, e) {
			var n, r, o, i, u, s = t.sortsBefore(e) ? [t, e] : [e, t];
			return void 0 === (null === (n = lt) || void 0 === n || null === (r = n[s[0].address]) || void 0 === r ? void 0 : r[s[1].address]) && (lt = P({}, lt, ((u = {})[s[0].address] = P({}, null === (o = lt) || void 0 === o ? void 0 : o[s[0].address], ((i = {})[s[1].address] = a.getCreate2Address("0xe3bFcc793a5fda775890e1DC39C7DCf872fEfF33", f.keccak256(["bytes"], [f.pack(["address", "address"], [s[0].address, s[1].address])]), y), i)), u))), lt[s[0].address][s[1].address]
		};
		var e = t.prototype;
		return e.involvesToken = function(t) {
			...
			if (this.involvesToken(e.token) || u(!1), i.equal(this.reserve0.raw, T) || i.equal(this.reserve1.raw, T)) throw new X;
			...
			if (this.involvesToken(e.token) || u(!1), i.equal(this.reserve0.raw, T) || i.equal(this.reserve1.raw, T) || i.greaterThanOrEqual(e.raw, this.reserveOf(e.token).raw)) throw new X;
			var n = this.reserveOf(e.token),
				r = this.reserveOf(e.token.equals(this.token0) ? this.token1 : this.token0),
			...
			if (o[0].token.equals(this.token0) && o[1].token.equals(this.token1) || u(!1), i.equal(t.raw, T)) r = i.subtract(J(i.multiply(o[0].raw, o[1].raw)), w);
			else {
	...
	ht = function() {
		function t(t, e, n) {
			...
			})) || u(!1), e instanceof K && t[0].involvesToken(e) || e === G && t[0].involvesToken(nt[t[0].chainId]) || u(!1), void 0 === n || n instanceof K && t[t.length - 1].involvesToken(n) || n === G && t[t.length - 1].involvesToken(nt[t[0].chainId]) || u(!1);
			...
			this.pairs = t, this.path = o, this.midPrice = ft.fromRoute(this), this.input = e, this.output = null != n ? n : o[o.length - 1]
		}
		return C(t, [{
			key: "chainId",
			get: function() {
...
var kt = function() {
	function t(t, e, n) {
		var r, o, i, a = new Array(t.path.length),
		...
		this.route = t, this.tradeType = n, this.inputAmount = n === exports.TradeType.EXACT_INPUT ? e : t.input === G ? ct.ether(a[0].raw) : a[0], this.outputAmount = n === exports.TradeType.EXACT_OUTPUT ? e : t.output === G ? ct.ether(a[a.length - 1].raw) : a[a.length - 1], this.executionPrice = new ft(this.inputAmount.currency, this.outputAmount.currency, this.inputAmount.raw, this.outputAmount.raw), this.nextMidPrice = ft.fromRoute(new ht(s, t.input)), this.priceImpact = (r = this.outputAmount, i = (o = t.midPrice.raw.multiply(this.inputAmount.raw)).subtract(r.raw).divide(o), new vt(i.numerator, i.denominator))
	}
	...
	return e.minimumAmountOut = function(t) {
		...
		var c = void 0 === o ? {} : o,
			...
			l = c.maxHops,
			p = void 0 === l ? 3 : l;
		void 0 === i && (i = []), void 0 === a && (a = n), void 0 === s && (s = []), e.length > 0 || u(!1), p > 0 || u(!1), a === n || i.length > 0 || u(!1);
		...
		for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
			...
			if ((w.token0.equals(m.token) || w.token1.equals(m.token)) && !w.reserve0.equalTo(T) && !w.reserve1.equalTo(T)) {
				...
				if (g.token.equals(v)) Q(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), f, wt);
		...
		var c = void 0 === o ? {} : o,
			...
			l = c.maxHops,
			p = void 0 === l ? 3 : l;
		void 0 === i && (i = []), void 0 === a && (a = r), void 0 === s && (s = []), e.length > 0 || u(!1), p > 0 || u(!1), a === r || i.length > 0 || u(!1);
		...
		for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
			...
			if ((w.token0.equals(m.token) || w.token1.equals(m.token)) && !w.reserve0.equalTo(T) && !w.reserve1.equalTo(T)) {
				...
				if (g.token.equals(v)) Q(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), f, wt);
				else if (p > 1 && e.length > 1) {
					var k = e.slice(0, y).concat(e.slice(y + 1, e.length));
		...
		return t.swapCallParameters = function(t, e) {
			...
			switch (t.tradeType) {
				case exports.TradeType.EXACT_INPUT:
					n ? (o = p ? "swapExactETHForTokensSupportingFeeOnTransferTokens" : "swapExactETHForTokens", i = [d, f, s, l], a = c) : r ? (o = p ? "swapExactTokensForETHSupportingFeeOnTransferTokens" : "swapExactTokensForETH", i = [c, d, f, s, l], a = "0x0") : (o = p ? "swapExactTokensForTokensSupportingFeeOnTransferTokens" : "swapExactTokensForTokens", i = [c, d, f, s, l], a = "0x0");
					break;
				case exports.TradeType.EXACT_OUTPUT:
					p && u(!1), n ? (o = "swapETHForExactTokens", i = [d, f, s, l], a = c) : r ? (o = "swapTokensForExactETH", i = [d, c, f, s, l], a = "0x0") : (o = "swapTokensForExactTokens", i = [d, c, f, s, l], a = "0x0")
			}
			return {
				methodName: o,
				args: i,
	...
	qt = function() {
		...
		return t.fetchTokenData = function(t, e, n, r, o) {
			try {
				...
				return Promise.resolve(s ? a(Ot[t][e]) : Promise.resolve(new l.Contract(e, bt, n).decimals().then((function(n) {
					var r, o, i;
