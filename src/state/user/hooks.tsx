import { ChainId, Pair, Token } from '../../custom_modules/@filterswap-libs/sdk'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Filter-LP', 'Filter LPs')
}
